...
@Slf4j
@Component
public class ChangeStatusFirmaService implements JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        optionalContractTemplate.ifPresent(
                c -> {
                    c.getTemplate().setEstado(ContractStatusType.FIRMA.toString());
        ...
        log.info("executed actualizanndo Contract:  {} , nuevo estado {}", contractTemplateId,ContractStatusType.FIRMA.toString());
    }
}
