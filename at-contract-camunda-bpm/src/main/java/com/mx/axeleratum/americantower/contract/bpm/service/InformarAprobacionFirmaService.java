...
@Slf4j
@Component
public class InformarAprobacionFirmaService implements JavaDelegate {
    @Autowired
    NotificationService notificationService;

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        log.info("executed InformarAprobacionFirmaService: {}", execution);
        ...
        String comment = "Se ha aprobado el contrato: " + cliente + " | " + assetNumber + " | " + tipoContrato + " | " + subTipoContrato + ", el cual se encuentra en estado Firma";
