...
@Slf4j
@Component
public class ChangeStatusRevisionService implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        optionalContractTemplate.ifPresent(
                c -> {
                    c.getTemplate().setEstado(ContractStatusType.REVISION.toString());
        ...
        log.info("executed actualizanndo Contract:  {} , nuevo estado {}", contractTemplateId,ContractStatusType.REVISION.toString());
    }
}
